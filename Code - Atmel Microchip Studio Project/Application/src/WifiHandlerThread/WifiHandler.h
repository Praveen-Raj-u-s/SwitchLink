...
#ifndef SECRET_H_
#define MAIN_WLAN_SSID "S22_Ultra"           /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "Exnihilonihilfit@01"      /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
#endif                                      /* SECRET_H_ */
...
#define MAIN_HTTP_FILE_URL "http://172.208.48.99/TestB.bin"  ///< Change me to the URL to download your OTAU binary file from!
...
#define PROXIMITY_TOPIC "P1_PROXIMITY_ESE516_T0"  // Students to change to an unique identifier for each device! Distance Data
#define CHARGER_TOPIC "P1_CHARGER_ESE516_T0"
...
#define PROXIMITY_TOPIC "P2_PROXIMITY_ESE516_T0"  // Students to change to an unique identifier for each device! Distance Data
#define CHARGER_TOPIC "P2_CHARGER_ESE516_T0"


#endif

//#define LED_TOPIC_2 "P1_LED_ESE516_T0"                  // Students to change to an unique identifier for each device! LED Data
#define LED_TOPIC_LED_OFF "false"
#define LED_TOPIC_LED_ON "send"

// Cloud MQTT User
#define CLOUDMQTT_USER_ID "azureuser"

// Cloud MQTT PASSWORD
#define CLOUDMQTT_USER_PASSWORD "azureuser"
 ...
 */
static const char main_mqtt_broker[] = "172.208.48.99";
...
void SubscribeHandlerChargerTopic(MessageData *msgData);
